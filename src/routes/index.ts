...
import { getTransactions, stockIn, receiveStock, adjustStock, returnStock, markExpired, getStockSummary, getLotsReport, getPendingStockIn, approveStockIn, rejectStockIn, getRequisitions, writeOffExpiredLots } from '../controllers/stock.controller';
...
r.post('/stock/write-off',        writeOffExpiredLots);
r.patch('/stock/:tx_id/approve',  approveStockIn);
r.patch('/stock/:tx_id/reject',   rejectStockIn);
r.get('/stock/requisitions',      getRequisitions);
